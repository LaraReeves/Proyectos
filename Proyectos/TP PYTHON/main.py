...
inicio = pygame.image.load("Python Invaders/imagenes/inicio.png")
fin = pygame.image.load("Python Invaders/imagenes/GameOver.png")
fondo = pygame.image.load("Python Invaders/imagenes/fondo.png")
laserSonido = pygame.mixer.Sound("Python Invaders/laser.wav")
explosionSonido = pygame.mixer.Sound("Python Invaders/explosion.wav")
golpeSonido = pygame.mixer.Sound("Python Invaders/golpe.wav")

# Lista de imagenes de explosiones
explosionList = []
for i in range(1, 13):
    explosion = pygame.image.load(f"Python Invaders/explosion/{i}.png")
...
class Jugador(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load("Python Invaders/imagenes/Nave.png").convert_alpha() # Carga la imagen de la nave del jugador
...
class Enemigos(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load("Python Invaders/imagenes/Rosa.png").convert_alpha() # Carga la imagen del enemigo
        self.rect = self.image.get_rect() # Obtiene el rectangulo asociado a la imagen
...
class Balas(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load("Python Invaders/imagenes/punto y coma.png").convert_alpha() # Carga la imagen de la bala
        self.rect = self.image.get_rect()  # Obtiene el rectangulo asociado a la imagen
...
class BalasEnemigos(pygame.sprite.Sprite):
        def __init__(self, x, y):
            ...
            self.image = pygame.image.load("Python Invaders/imagenes/tab.png").convert_alpha()  # Carga la imagen de la bala del enemigo
