...
int main(){
    ...
    struct propiedad propiedades[] = {
                    ...
                    {4, {23, 12, 2019}, "Capital Federal", "Palermo", 1, 1, 85.0, 50.0, 295000.0, "PESOS", "PH", "Alquiler", {0, 0, 0}, 1},
                    {5, {11, 3, 2020}, "G.B.A. Zona Sur", "La Plata", 1, 1, 50.0, 35.0, 40000.0, "USD", "Casa", "Venta", {24, 7, 2021}, 0},
                    {6, {1, 11, 2019}, "Capital Federal", "Villa Crespo", 1, 1, 56.0, 56.0, 150000.0, "USD", "PH", "Venta", {0, 0, 0}, 1},
                    {7, {31, 10, 2019}, "Capital Federal", "Villa Crespo", 1, 1, 70.0, 70.0, 159500.0, "USD", "Departamento", "Venta", {0, 0, 0}, 1},
                    ...
                    {11, {7, 12, 2019}, "Capital Federal", "Villa Pueyrred\xA2n", 1, 2, 66.0, 49.0, 170000.0, "USD", "PH", "Venta", {0, 0, 0}, 1},
                    {12, {26, 10, 2019}, "Capital Federal", "Boedo", 1, 1, 68.0, 59.0, 149000.0, "PESOS", "Departamento", "Alquiler", {0, 0, 0}, 1},
    ...
    do {
        ...
        switch (opcion) {
            ...
            case 3:
                ...
                numProp = agregarPropiedad(numProp);
